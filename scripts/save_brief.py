#!/usr/bin/env python3
"""생성된 마케팅 브리핑을 로컬(data/briefs/)에 저장한다.

kind: morning(오늘의 마케팅 큐) · evening(저녁 마감) · weekly(주간 판정) ·
      monthly(월간 리뷰) · team(팀 공유용) · private(나만 보기)
...
def main():
    ap = argparse.ArgumentParser(description="마케팅 브리핑 로컬 저장")
    ap.add_argument("--kind", choices=["morning", "evening", "weekly", "monthly", "team", "private"],
                    default="morning")
