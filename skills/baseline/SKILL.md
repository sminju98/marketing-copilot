...
```bash
marketing-copilot baseline show                    # 전체
marketing-copilot baseline show --channel meta     # 채널별
marketing-copilot baseline sources                 # 출처 목록
```
...
> Gordon 외 2023(RCT 663건): 실제 리프트 중앙값 5%를 관찰 기반 방법이 **24~64%로 추정**했다.
